...
<body>
	...
	<form:hidden path="reviewRate" id="reviewRate"/>
        ...
        <label>작성일: </label>${review.reviewDate}
        </div>
        </div>
	<form:hidden path="reviewNo" value="${review.reviewNo}" display="none"/>
	<form:hidden path="productNo" value="${review.productNo}" display="none"/>
	<form:hidden path="orderProductsNo" value="${review.orderProductsNo}" display="none"/>
    <div class="revbutton">
	<div class="rbutton">
